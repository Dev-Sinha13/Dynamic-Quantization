...
benchmark. The [packed T4 pilot](experiments/2026-09-05-packed-t4-pilot.md)
passed its GPU correctness gates; it saved cache storage but not end-to-end time.
The older T4 archive only tests dense cache reconstruction.
